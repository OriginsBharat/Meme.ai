...
class TTSManager:
    ...
    def generate_tts_audio(self, text_to_speak: str, output_filepath: str, voice: str = "Laura", model: str = "eleven_multilingual_v2") -> str | None:
        """
        ...
        try:
            ...
            logging.error(f"Failed to generate or save TTS audio: {e}")
            return None
    ...
    def get_subscription_info(self) -> dict | None:
        ...
        Returns:
            dict | None: A dictionary with subscription details (character count,
                         limit, status, etc.) or None if an error occurs.
        """
        ...
        try:
            ...
            logging.error(f"Failed to fetch subscription info: {e}")
            return None
